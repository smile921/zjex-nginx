#define NGX_CONFIGURE " --prefix=/home/nginx-openresty/nginx --with-cc-opt='-O2 -I/usr/local/openssl/include/ -I/usr/local/pcre/include/' --add-module=../ngx_devel_kit-0.2.19 --add-module=../iconv-nginx-module-0.13 --add-module=../echo-nginx-module-0.58 --add-module=../xss-nginx-module-0.05 --add-module=../ngx_coolkit-0.2rc3 --add-module=../set-misc-nginx-module-0.29 --add-module=../form-input-nginx-module-0.11 --add-module=../encrypted-session-nginx-module-0.04 --add-module=../srcache-nginx-module-0.30 --add-module=../ngx_lua-0.10.0 --add-module=../ngx_lua_upstream-0.04 --add-module=../headers-more-nginx-module-0.29 --add-module=../array-var-nginx-module-0.04 --add-module=../memc-nginx-module-0.16 --add-module=../redis2-nginx-module-0.12 --add-module=../redis-nginx-module-0.3.7 --add-module=../rds-json-nginx-module-0.14 --add-module=../rds-csv-nginx-module-0.07 --with-ld-opt='-Wl,-rpath,/home/nginx-openresty/luajit/lib -Wl,-rpath,/usr/local/lib -L/usr/local/openssl/lib/ -L/usr/local/pcre/lib/' --with-openssl=/media/zuo/100g-data/git/zjex-nginx/src/ngx_openresty-1.9.7.2/../openssl-1.0.2e --with-pcre=/media/zuo/100g-data/git/zjex-nginx/src/ngx_openresty-1.9.7.2/../pcre-8.38 --with-http_ssl_module"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/nginx-openresty/nginx/"
#endif
