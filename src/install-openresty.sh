...
#wget -q https://github.com/openresty/ngx_openresty/archive/${VER_OPENRESTY}.tar.gz -O ngx_openresty-${VER_OPENRESTY}.tar.gz
wget -q https://openresty.org/download/ngx_openresty-1.9.7.2.tar.gz -O ngx_openresty-${VER_OPENRESTY}.tar.gz
# Untar
...
tar -zxvf ngx_openresty-${VER_OPENRESTY}.tar.gz && rm ngx_openresty-${VER_OPENRESTY}.tar.gz
